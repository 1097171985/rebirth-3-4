...
#define NormalAttributes   @{NSForegroundColorAttributeName: [UIColor titleLightBlackColor], NSFontAttributeName:[UIFont systemFontOfSize:15]}
#define SelectedAttributes @{NSForegroundColorAttributeName: [UIColor titleBlueColor], NSFontAttributeName:[UIFont systemFontOfSize:15]}
...
@property (nonatomic, strong) NSArray *sectionSelectedTitles;
...
/**
 ...
 Default is `[UIColor titleBlueColor]`
 */
