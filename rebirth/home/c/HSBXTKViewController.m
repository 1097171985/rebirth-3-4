...
@interface HSBXTKViewController ()

@end

@implementation HSBXTKViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.rempeach.com/rempeach/indexs/insurance_clause.html"];
    //http://www.rempeach.com/rempeach/indexs/insurance_clause.html
    [webView loadRequest:[NSURLRequest requestWithURL:url]];
    
//    NSString *path = [[NSBundle mainBundle] bundlePath];
//    NSURL *baseURL = [NSURL fileURLWithPath:path];
//    NSString * htmlPath = [[NSBundle mainBundle] pathForResource:@"insurance_clause"
//                                                          ofType:@"html"];
