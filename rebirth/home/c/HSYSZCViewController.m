...
@interface HSYSZCViewController ()

@end

@implementation HSYSZCViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.rempeach.com/rempeach/indexs/privacy_policy.html"];
    //http://www.rempeach.com/rempeach/indexs/privacy_policy.html
    [webView loadRequest:[NSURLRequest requestWithURL:url]];
//    NSString *path = [[NSBundle mainBundle] bundlePath];
//    NSURL *baseURL = [NSURL fileURLWithPath:path];
//    NSString * htmlPath = [[NSBundle mainBundle] pathForResource:@"privacy_policy"
//                                                          ofType:@"html"];
