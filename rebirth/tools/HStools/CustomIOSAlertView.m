...
- (id)init
{
    ...
    if (self) {
        ...
        buttonTitles = @[@"Close"];
        bntArr = [[NSMutableArray alloc]initWithCapacity:0];
...
//    lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
        lineView.backgroundColor = [NSString colorWithHexString:heitizi];

    [dialogContainer addSubview:lineView];
    
    UIView *lineVIew = [[UIView alloc]initWithFrame:CGRectMake(dialogContainer.bounds.size.width/2, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight+1, buttonSpacerHeight, 50)];
    lineVIew.backgroundColor = [NSString colorWithHexString:heitizi];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        //        [closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f] forState:UIControlStateNormal];
                ...
                [closeButton setTitleColor:[NSString colorWithHexString:heitizi] forState:UIControlStateNormal];
        if (i==1) {
            [closeButton setTitleColor:[NSString colorWithHexString:@"ffffff"] forState:UIControlStateNormal];
        }
        if (buttonTitles.count == 1) {
            self.clickBnt = closeButton;
      ...
      //  [closeButton.layer setCornerRadius:kCustomIOSAlertViewCornerRadius];
        ...
        container.backgroundColor = [NSString colorWithHexString:@"ffffff"];
