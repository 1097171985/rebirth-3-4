...
- (NSString *)timeIntervalDescription
{
	...
	if (timeInterval < 60) {
       ...
       // return @"刚刚";
        ...
        return @"今天";
       // return [NSString stringWithFormat:@"%.f分钟", timeInterval / 60];
	} else if (timeInterval < 86400) {
        return @"今天";
      //  return [NSString stringWithFormat:@"%.f小时", timeInterval / 3600];
    }else if (timeInterval<86400*2){
        return @"昨天";
    }
//    else if (timeInterval < 2592000) {//30天内
//        return @"昨天";
//       // return [NSString stringWithFormat:@"%.f天", timeInterval / 86400];
//    }
    else if (timeInterval < 31536000) {//30天至1年内
        NSDateFormatter *dateFormatter = [NSDateFormatter dateFormatterWithFormat:@"M月"];
        return [dateFormatter stringFromDate:self];
    } else {
        return [NSString stringWithFormat:@"%.f年", timeInterval / 31536000];
    }
}
