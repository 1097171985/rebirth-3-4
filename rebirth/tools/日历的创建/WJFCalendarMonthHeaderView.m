//
//  WJFCalendarCollectionReusableView.m
//  一些常用的知识点
//
...
@interface  WJFCalendarMonthHeaderView()
...
#define CATDayLabelWidth   (WIDTH-12)/7-5.0
#define CATDayLabelHeight 20.0f

@implementation WJFCalendarMonthHeaderView
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, WIDTH, 30.f)];
    ...
    UILabel *henxian = [[UILabel alloc]initWithFrame:CGRectMake(0,45+CATDayLabelHeight, WIDTH,3)];
    henxian.backgroundColor = [NSString colorWithHexString:@"#6d7278"];
