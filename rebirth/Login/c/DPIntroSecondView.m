...
@implementation DPIntroSecondView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [itemImageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"welcome_item2_ip%@", isIphone4? @"4":@"6p"]]];
        ...
        [titleImageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"welcome_title2_ip%@", isIphone4? @"4":@"6p"]]];
        [self addSubview:titleImageView];
        
        textImageView = [[UIImageView alloc] init];
        [textImageView setContentMode:UIViewContentModeScaleAspectFill];
        [textImageView setImage:[UIImage imageNamed:[NSString stringWithFormat:@"welcome_text2_ip%@", isIphone4? @"4":@"6p"]]];
        ...
        if (isIphone4) {
            ...
            [titleImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset(-(kScreenWidth + 125)/2.f);
            ...
            [titleImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset(-(kScreenWidth + 160)/2.f);
