    ...
    if (self) {
        ...
        if (isIphone4) {
            [logoImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(weakSelf.mas_top).offset(78);
                make.centerX.equalTo(weakSelf.mas_centerX);
                make.width.equalTo(@(130));
                make.height.equalTo(@(39));
            }];
            
            [slogonImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(weakSelf.mas_top).offset(240/667.f*kScreenHeight);
                make.centerX.equalTo(weakSelf.mas_centerX);
            ...
            [joinButton mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset(-(kScreenWidth + 144)/2.f);
                make.top.equalTo(weakSelf.mas_bottom).offset(-108);
            ...
            [textImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset((kScreenWidth + 144)/2.f);
                make.top.equalTo(weakSelf.mas_bottom).offset(-50);
                make.width.equalTo(@(144));
                make.height.equalTo(@(14));
            }];
        }else {
            [logoImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(weakSelf.mas_top).offset(110/667.f*kScreenHeight);
                make.centerX.equalTo(weakSelf.mas_centerX);
            ...
            [joinButton mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset(-(kScreenWidth + 200)/2.f);
                make.top.equalTo(weakSelf.mas_bottom).offset(-150/667.f*kScreenHeight);
            ...
            [textImageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(weakSelf.mas_centerX).offset((kScreenWidth + 200)/2.f);
                make.top.equalTo(weakSelf.mas_bottom).offset(-70/667.f*kScreenHeight);
                make.width.equalTo(@(200));
...
- (void)subviewsAnimation
{
    if (!animating) {
        animating = YES;
        [joinButton mas_updateConstraints:^(MASConstraintMaker *make) {
