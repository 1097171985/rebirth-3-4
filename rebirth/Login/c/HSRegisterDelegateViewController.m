//
//  HSRegisterDelegateViewController.m
//  rebirth
//
...
@interface HSRegisterDelegateViewController ()

@end

@implementation HSRegisterDelegateViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.rempeach.com/rempeach/list/service_agreement.html"];
    [webView loadRequest:[NSURLRequest requestWithURL:url]];
    
//    NSString *path = [[NSBundle mainBundle] bundlePath];
//    NSURL *baseURL = [NSURL fileURLWithPath:path];
//    NSString * htmlPath = [[NSBundle mainBundle] pathForResource:@"service_agreement"
//                                                          ofType:@"html"];
